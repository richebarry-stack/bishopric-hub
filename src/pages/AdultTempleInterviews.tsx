...
export default function AdultTempleInterviews() {
  return (
    <InterviewsPage
      ...
      description="Temple recommend and annual interviews for adult members — who's due, who's coming due, and who's assigned to conduct or set up each interview."
      types={[...TEMPLE_TYPES]}
      showRecExpires
    />
  );
