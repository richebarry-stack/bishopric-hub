...
const VERSION_HISTORY: { date: string; items: string[] }[] = [
            {
              ...
              items: [
                ...
                'The Bishop/Counselor Schedule and Tithing Declaration weekly calendars now always fill the available screen height with no scrollbar — row heights scale to fit and are floored to a whole pixel so sub-pixel rounding across all the rows can\'t force a 1px scrollbar.',
