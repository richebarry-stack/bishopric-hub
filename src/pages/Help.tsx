...
const VERSION_HISTORY: { date: string; items: string[] }[] = [
            {
              ...
              items: [
                ...
                'The Bishop/Counselor Schedule and Tithing Declaration weekly calendars now always fill the available screen height — row heights scale to fit instead of a fixed size that sometimes left empty space and sometimes forced a scrollbar. Fixed a follow-up bug where the calendar could end up neither scrolling nor filling the screen, hiding rows below the fold with no way to reach them.',
