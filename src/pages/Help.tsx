...
const VERSION_HISTORY: { date: string; items: string[] }[] = [
            {
              ...
              items: [
                ...
                'The Bishop/Counselor Schedule and Tithing Declaration weekly calendars now always fill the available screen height with no scrollbar — row heights scale to fit, floored to a whole pixel so sub-pixel rounding can\'t force a scrollbar, and the hour-label text no longer forces rows taller than that computed height. Verified live in the browser this time.',
