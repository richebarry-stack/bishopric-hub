...
const VERSION_HISTORY: { date: string; items: string[] }[] = [
            {
              ...
              items: [
                ...
                'The Bishop/Counselor Schedule and Tithing Declaration weekly calendars now fill the available screen height when there\'s room, but each 15-minute row has a minimum height so appointment titles stay readable — on a shorter screen the calendar scrolls rather than shrinking text into illegibility.',
